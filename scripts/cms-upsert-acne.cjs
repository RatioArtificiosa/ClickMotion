...
const raw = fs.readFileSync(
  path.join(root, "content/prompts/heroes/MS-HERO-ACNE01.mdx"),
  "utf8"
);
...
const product = {
  ...
  description: desc,
  type: primaryType,
  // Multi-type browse (Hero + Landing Page) — same idea as type+genre dual chips
  types:
    typesArr.length > 0
  ...
  estimatedTokens: Number(get("estimatedTokens") || 10500),
