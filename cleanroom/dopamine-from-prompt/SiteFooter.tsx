...
import { scrambleChars, splitToChars } from "./scramble";
  ...
  useEffect(() => {
    ...
    const ensureLottie = () => {
      ...
      anim = lottie.loadAnimation({
        ...
        loop: false,
        autoplay: false,
        path: "/assets/dopamine/FOOTER_LOTTIE_v1.json",
        rendererSettings: {
          clearCanvas: true,
    ...
    <footer className="footer" ref={rootRef}>
      <picture className="footer__bg">
        <source
          ...
          srcSet="/assets/dopamine/footer_bg_desk-scaled.webp"
        />
        <source
          media="(min-width: 768px)"
          srcSet="/assets/dopamine/footer_bg_tablet.webp"
        />
        <img src="/assets/dopamine/footer_bg_mob.webp" alt="" />
      </picture>

      <picture className="footer__img" ref={imgRef}>
        <img src="/assets/dopamine/Woman1.png" alt="" />
      </picture>

      <div
        className="footer__discount"
        ref={discountRef}
        data-lottie="/assets/dopamine/FOOTER_LOTTIE_v1.json"
      >
