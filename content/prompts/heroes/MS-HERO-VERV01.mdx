...
styleTags: ["playful", "gradient-mesh"]
...
previewVideo: "/previews/MS-HERO-VERV01.mp4"
previewGif: "/previews/MS-HERO-VERV01.gif"
thumbnail: "/thumbnails/MS-HERO-VERV01.webp"
liveDemo: "/demos/MS-HERO-VERV01"
videoBackgrounds:
  - file: "/assets/videos/verve-montage-v1.mp4"
    format: "mp4"
    duration: "10s"
    loop: true
    sizeMb: 4
    poster: "/assets/posters/verve-montage-v1.webp"
dependencies:
...
useCases: ["saas-productivity-homepage", "landing-page"]
...
**Aesthetic Direction:** Premium playful + gradient-mesh - VERVE SOCIAL - Vibrant Gen-Z Social Platform Hero rendered with #1A0A14, #EC4899, #F59E0B and Clash Display typography. High-contrast, production-ready.

**Typography:**
- Headings: `Clash Display` - font-weight: 700-900, letter-spacing: -0.04em, line-height: 0.85, sizes: clamp(3rem, 8vw, 8rem)
...
|------|--------------|------------|-------|
| headline | "BE SEEN." | 25 chars | Primary H1 |
| subheadline | "Second line" | 20 chars | Secondary color |
| description | "Production-ready hero for saas - built for productivity." | 180 chars | Supports markdown |
...
- File: `/assets/videos/verve-montage-v1.mp4` (MP4 H.264, 1920x1080, 10s, <5MB, no audio)
- Poster: `/assets/posters/verve-montage-v1.webp` (1920x1080, <150KB WebP)
...
> **AI Video Generation Prompt:** Cinematic 4K video, 30 seconds, seamless loop. Premium VERVE SOCIAL - Vibrant Gen-Z Social Platform Hero background - A high-energy hero for a social media app with gradient mesh, bold typography, a lifestyle montage video, and an infinite marquee of trending hashtags. Color grading: cinematic, volumetric light, 24fps, no people, no text, no UI. Seamless loop.
