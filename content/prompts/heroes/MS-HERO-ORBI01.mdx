...
previewVideo: "/previews/MS-HERO-ORBI01.mp4"
previewGif: "/previews/MS-HERO-ORBI01.gif"
thumbnail: "/thumbnails/MS-HERO-ORBI01.webp"
liveDemo: "/demos/MS-HERO-ORBI01"
videoBackgrounds:
  - file: "/assets/videos/orbit-data-v1.mp4"
    format: "mp4"
    duration: "12s"
    loop: true
    sizeMb: 2.9
    poster: "/assets/posters/orbit-data-v1.webp"
dependencies:
...
useCases: ["fintech-banking-homepage", "landing-page"]
...
**Aesthetic Direction:** Premium corporate + luxury - ORBIT FINANCE - Trustworthy Neobank Hero rendered with #0F172A, #F59E0B, #E2E8F0 and DM Serif Display typography. High-contrast, production-ready.

**Typography:**
- Headings: `DM Serif Display` - font-weight: 700-900, letter-spacing: -0.04em, line-height: 0.85, sizes: clamp(3rem, 8vw, 8rem)
...
|------|--------------|------------|-------|
| headline | "Money, elevated." | 25 chars | Primary H1 |
| subheadline | "Second line" | 20 chars | Secondary color |
| description | "Production-ready hero for fintech - built for banking." | 180 chars | Supports markdown |
...
- File: `/assets/videos/orbit-data-v1.mp4` (MP4 H.264, 1920x1080, 12s, <5MB, no audio)
- Poster: `/assets/posters/orbit-data-v1.webp` (1920x1080, <150KB WebP)
...
> **AI Video Generation Prompt:** Cinematic 4K video, 30 seconds, seamless loop. Premium ORBIT FINANCE - Trustworthy Neobank Hero background - A clean, premium hero for a neobank with abstract financial data visualizations, navy and gold accents, and a trust-focused layout. Color grading: cinematic, volumetric light, 24fps, no people, no text, no UI. Seamless loop.
